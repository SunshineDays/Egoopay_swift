//
//  WPSelectAddresssController.swift
//  Egoopay
//
...
typealias WPSelectAddresssType = (_ province: String, _ provinceID: String, _ city: String, _ cityID: String, _ area: String, _ areaID: String) -> Void


class WPSelectAddresssController: WPBaseTableViewController {
    ...
    override func viewDidLoad() {
        ...
        let plistPath = Bundle.main.path(forResource: "areaArray", ofType: "plist")!
    ...
    var selectedAddressType: WPSelectAddresssType?
