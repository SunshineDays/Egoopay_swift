//
//  WPEShopMyLookRecordController.swift
//  Egoopay
//
...
class WPEShopMyLookRecordController: WPBaseViewController, UITableViewDelegate, UITableViewDataSource {
    ...
    @objc func cancelLoveAction() {
        ...
        if removeArray.count == 0 {
            ...
            postDeleteLookRecordData(array: removeArray, indexPathArray: indexPathArray)
        }
    }
    ...
    func getlookRecordData() {
        ...
        WPDataTool.GETRequest(url: WPEShopLoveListURL, parameters: nil, success: { (result) in
            ...
            weakSelf?.tableViewNoData(tableView: weakSelf?.tableView, image: #imageLiteral(resourceName: "icon_eShop_noResult_shop"), title: "您还没有浏览的商品")
    ...
    //删除浏览记录
    func postDeleteLookRecordData(array: NSMutableArray, indexPathArray: NSMutableArray) {
